...
namespace {
  ...
  PieceInfo* knibis_piece() {
      PieceInfo* p = new PieceInfo();
      p->name = "knibis";
	  p->stepsQuiet = {2*SOUTH, 2*WEST, 2*EAST, 2*NORTH, 2 * SOUTH + WEST, 2 * SOUTH + EAST, SOUTH + 2 * WEST, SOUTH + 2 * EAST,
                       NORTH + 2 * WEST, NORTH + 2 * EAST, 2 * NORTH + WEST, 2 * NORTH + EAST};
      p->stepsCapture = {2*SOUTH, 2*WEST, 2*EAST, 2*NORTH, 2 * SOUTH + WEST, 2 * SOUTH + EAST, SOUTH + 2 * WEST, SOUTH + 2 * EAST,
                       NORTH + 2 * WEST, NORTH + 2 * EAST, 2 * NORTH + WEST, 2 * NORTH + EAST};
      return p;
  }
  ...
  PieceInfo* fers_alfil_piece() {
      PieceInfo* p = new PieceInfo();
      p->name = "fers_alfil";
      p->stepsQuiet = {2 * SOUTH + WEST, 2 * SOUTH + EAST, SOUTH + 2 * WEST, SOUTH + 2 * EAST,                         NORTH + 2 * WEST, NORTH + 2 * EAST, 2 * NORTH + WEST, 2 * NORTH + EAST,
   					   3 * SOUTH + WEST, 3 * SOUTH + EAST, SOUTH + 3 * WEST, SOUTH + 3 * EAST,
                       NORTH + 3 * WEST, NORTH + 3 * EAST, 3 * NORTH + WEST, 3 * NORTH + EAST};
      p->stepsCapture = { 2 * SOUTH + WEST, 2 * SOUTH + EAST, SOUTH + 2 * WEST, SOUTH + 2 * EAST,                         NORTH + 2 * WEST, NORTH + 2 * EAST, 2 * NORTH + WEST, 2 * NORTH + EAST,
   					   3 * SOUTH + WEST, 3 * SOUTH + EAST, SOUTH + 3 * WEST, SOUTH + 3 * EAST,
                       NORTH + 3 * WEST, NORTH + 3 * EAST, 3 * NORTH + WEST, 3 * NORTH + EAST};
      return p;
  }
