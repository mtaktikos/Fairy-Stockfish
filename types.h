...
enum Value : int {
  ...
  RookValueMg   = 2060,  RookValueEg   = 2150,
  QueenValueMg  = 2538,  QueenValueEg  = 2682,
  FersValueMg              = 420,   FersValueEg              = 450,
  AlfilValueMg             = 330,   AlfilValueEg             = 300,
  FersAlfilValueMg         = 1700,   FersAlfilValueEg         = 1750,
  SilverValueMg            = 630,   SilverValueEg            = 630,
  AiwokValueMg             = 2500,  AiwokValueEg             = 2500,
  BersValueMg              = 2060,  BersValueEg              = 2150,
  ArchbishopValueMg        = 1930,  ArchbishopValueEg        = 2030,
  ChancellorValueMg        = 2300,  ChancellorValueEg        = 2600,
  AmazonValueMg            = 1550,  AmazonValueEg            = 1620,
  KnibisValueMg            = 1700,  KnibisValueEg            = 1750,
