...
namespace {
	...
	/* Variant* xchess_variant() {
	Variant* v = chess_variant();
	//Variant* v = fairy_variant_base();
    v->pieceToCharTable = "PNBRQ..A....W.D......Kpnbrq..a....w.d......k";
	//v->pieceToCharTable = "PNBRQGEACJMTHIDVOWSULKpnbrqgeacjmthidvowsulk";
		v->remove_piece(BISHOP);
		v->remove_piece(KNIGHT);
		v->add_piece(ARCHBISHOP, 'a');
		v->add_piece(FERS_ALFIL, 'w');
		//v->castlingRookPiece = BERS;
		v->startFen = "rwaqkawr/pppppppp/8/8/8/8/PPPPPPPP/RWAQKAWR w KQkq - 0 1";
        v->promotionPieceTypes = {QUEEN, ROOK, ARCHBISHOP, FERS_ALFIL};
		//v->castling = true;
		return v;
    }
	Variant* xchess2_variant() {
	Variant* v = chess_variant();      
	//Variant* v = fairy_variant_base();
	v->pieceToCharTable = "PNBRQW.A......D......Kpnbrqw.a......d......k";
		v->remove_piece(BISHOP);
		v->remove_piece(KNIGHT);
		v->add_piece(ARCHBISHOP, 'a');
		v->add_piece(AMAZON, 'w');
		//v->castlingRookPiece = BERS;
		v->startFen = "rwaqkawr/pppppppp/8/8/8/8/PPPPPPPP/RWAQKAWR w KQkq - 0 1";
		v->promotionPieceTypes = {QUEEN, ROOK, ARCHBISHOP, AMAZON};
		//v->castling = true;	
        return v;
    } */
	Variant* xchess3_variant() {
	Variant* v = chess_variant();  
	//Variant* v = fairy_variant_base();
	v -> pieceToCharTable = "PNB.Q........A................RMKpnb.q........a................rmk";
	//v -> pieceToCharTable = "PNBRQ........A.................MKpnbrq........a.................mk";
		v->remove_piece(BISHOP);
		v->remove_piece(KNIGHT);
		v->add_piece(ARCHBISHOP, 'a');
		v->add_piece(KNIBIS, 'm');
		v->startFen = "rmaqkamr/pppppppp/8/8/8/8/PPPPPPPP/RMAQKAMR w KQkq - 0 1";
		v->promotionPieceTypes = {QUEEN, ROOK, ARCHBISHOP, KNIBIS};	
        return v;
    } 
...
void VariantMap::init() {
   ...
   /* add("makruk", makruk_variant());
    ...
    //add("xchess", xchess_variant());
	//add("xchess2", xchess2_variant());
	add("x-chess", xchess3_variant());
