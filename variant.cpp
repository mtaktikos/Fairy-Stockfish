...
namespace {
	...
	Variant* v = chess_variant();  
	//Variant* v = fairy_variant_base();
	 v->pieceToCharTable = "P..RQ.........................D.....GKp..rq.........................d.....gk"; 
		v->remove_piece(BISHOP);
		v->remove_piece(KNIGHT);
		v->add_piece(ARCHBISHOP, 'g');
		v->add_piece(KNIBIS, 'd');
		v->startFen = "rdgqkgdr/pppppppp/8/8/8/8/PPPPPPPP/RDGQKGDR w KQkq - 0 1";
