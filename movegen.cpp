...
namespace {
  ...
  ExtMove* generate_pawn_moves(const Position& pos, ExtMove* moveList, Bitboard target) {
	...
	Bitboard TRank6BB = shift<Down>(TRank7BB);
	Bitboard TRank5BB = shift<Down>(TRank6BB);
	Bitboard TRank4BB = shift<Down>(TRank5BB);
	...
	Bitboard pawnsOn4    = pos.pieces(Us, PAWN) &  TRank4BB; 
