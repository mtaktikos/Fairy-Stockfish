...
namespace {
  ...
  ExtMove* generate_pawn_moves(const Position& pos, ExtMove* moveList, Bitboard target) {
    ...
    Bitboard pawnsOn2    = pos.pieces(Us, PAWN) &  TRank2BB; 
    ...
    if (Type != CAPTURES)
    {
		...
		Bitboard b3 = shift<Right>(pawnsOn2) & emptySquares;
		Bitboard b4 = shift<Left>(pawnsOn2) & emptySquares;
		Bitboard b5 = shift<Right>(pawnsOn7) & emptySquares;
		Bitboard b6 = shift<Left>(pawnsOn7) & emptySquares;
		Bitboard b7 = shift<Down>(pawnsNotOn2) & emptySquares;
